...
class MemberRepositoryTest {
    ...
    public void returnType() {
        ...
        List<Member> findListMember = memberRepository.findListByUsername("AAA"); // 만약 값이 없으면 emptylist 반환. != null인지 체크할 필요 없음
...
//        em.clear();
    ...
    public void findMemberLazy() {
        ...
        //when
        //select Member 1, select Team N (N+1 문제)
...
//        List<Member> members = memberRepository.findMemberFetchJoin();
    ...
    public void projections() {
        ...
        List<NestedClosedProjections> nestedClosedProjections = memberRepository.findDtoProjectionsByUsername("m1", NestedClosedProjections.class);
